...
1. Write a generic function that doubles the value of any integer or float
   that’s passed in to it. Define any needed generic interfaces.

2. Define a generic interface called `Printable` that matches a type that
...
3. Write a generic singly linked list data type. Each element can hold a
